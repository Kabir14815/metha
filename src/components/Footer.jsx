    ...
    <footer className="footer">
      ...
      <div className="container">
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <Link to={link.href.startsWith('#') ? linkTo(link.href) : link.href}>{link.name}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              {services.map((service, index) => (
                <li key={index}>
                  <Link to={linkTo('#services')}>{service}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="footer-column">
            ...
            <div className="contact-info">
              <div className="contact-item">
                ...
                <span>22 A, Sector 12, Garden Colony, Kharar, Punjab 140301</span>
              </div>
              <div className="contact-item">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                </svg>
                <a href="tel:9855121155">+91 98551 21155</a>
              </div>
              <div className="contact-item">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <a href="mailto:Mehtahospitalmohali@gmail.com">Mehtahospitalmohali@gmail.com</a>
              </div>
        ...
        <div className="footer-bottom">
          <p>&copy; {currentYear} Mehta Hospital. All rights reserved.</p>
